...
<!------------------------------------Booking Form-------------------------------->
    ...
    <section class="booking-form">
        <div class="container">
          <div class="row">
            <div class="col-md-4 offset-4 booking">
              ...
              <form action="booking_process.php" method="POST">
                <form action="e_ticket.php" method="POST">
                  <div class="col-md-12 form">
                     <input type="text" id="username" name="name" class="form-control" placeholder="Full name" required>
                  </div> 
                  
                  <div class="col-md-12 form">
                      <input name="phone" id="tel" class="form-control" placeholder="Phone number" type="text" required>
                   </div>
                  ...
                  <div class="col-md-12 form">
                   ...
                   <div class="col-md-12 form ">
                          <label for="Jonining-Date">Journey Date:</label>
                          <input type="date" id="b=join" name="p_date" required>
                        
                   </div>
                   
                   <div class="col-md-12 form ">
                         <label for="appt">Journey Time:</label> 
                  ...
                  <div class="row">
                    <div class="col-md-12 form">
                      <button type="submit" name="submit" class="btn btn-primary btn-block confirm" >Booking Confirm</button>
                   </div> 
                  </div> 
